...
class SrealityClientSettings(BaseSettings):
    ...
    detail_url_template_house: str = (
        "https://www.sreality.cz/detail/prodej/dum/rodinny/{seo}/{id}"
    )
    detail_url_template_flat: str = (
        "https://www.sreality.cz/detail/prodej/byt/{disposition}/{seo}/{id}"
    )
    per_page: int = 100
